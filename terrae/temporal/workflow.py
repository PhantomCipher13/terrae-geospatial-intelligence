...
from terrae.core.result import RegistrationResult, RegistrationStatus, ChangeVerdict
from terrae.providers.change.base import TemporalChangeResult
...
class TemporalAnalysisWorkflow:
    ...
    def run_analysis(self, tile_id: str, query_text: Optional[str] = None) -> TemporalChangeResult:
        ...
        try:
            from terrae.change.attribution import attribute_change
            change_mask = None
            if result.evidence:
