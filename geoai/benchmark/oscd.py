...
from geoai.providers.change.base import ChangeDetector, TemporalChangeResult
...
def evaluate_oscd_pair(
    ...
    Args:
        detector: Any ChangeDetector adhering to the geoai interface.
