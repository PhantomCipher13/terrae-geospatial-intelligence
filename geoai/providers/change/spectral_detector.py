"""
geoai/providers/change/spectral_detector.py
...
from geoai.providers.change.base import ChangeDetector, TemporalChangeResult, ChangeEvidence
from geoai.core.result import ChangeVerdict, RegistrationResult, RegistrationStatus
